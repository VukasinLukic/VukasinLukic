# Hey, I'm Vukašin Lukić 👋

**Full Stack & Mobile Developer · Co-founder @ [4Sports](https://github.com/VukasinLukic)**

I build modern web and mobile apps — from idea to production. Currently focused on [4Sports](https://github.com/VukasinLukic), a sports club management platform in pre-seed, and exploring ML on the side.

📍 Belgrade, Serbia · ✉️ [vukasin4sports@gmail.com](mailto:vukasin4sports@gmail.com)
...
| **Tradey** | Web trading app · currently in development | React, TypeScript |
...
- **Part-time Developer @ AJSA Soft** — worked on production apps: a real estate platform and a medical appointment scheduling system
